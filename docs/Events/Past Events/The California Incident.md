...
- **Setting name, resolved (2026-07-16, decided live, grill-canon session):** Staying with California — plain "a small town in California," not San Bruno, not Baton Rouge, and not renamed "The Louisiana Incident." Dave's reasoning: it makes more sense for [[Deputy Humboldt|Humboldt]] to have heard of an incident in California than one in Louisiana, simply on geographic proximity to Colorado — notable since *why* Humboldt knows anything about Rudy at all is still its own unresolved mystery (see [[The Disappearance of Clara McKenzie]] open threads). The San Bruno and Baton Rouge retcons, and the "Louisiana Incident" naming idea, are all set aside.
...
- **2026-07-16 (decided live, grill-canon session):** Setting name resolved — staying with California, over both real-world retcons and the "Louisiana Incident" rename idea.